...
//CVector3D & CVector3D::operator=(const POINT_STRUCT & p)
//{
//	POINT_STRUCT curPt = p;
//	pVec[0] = curPt.p_x;	pVec[1] = curPt.p_y;	pVec[2] = curPt.p_z;
//	return (*this);
//}
bool CVector3D::operator==(const CVector3D& v)
{	
	if (pVec[0] == v.pVec[0] && pVec[1] == v.pVec[1] && pVec[2] == v.pVec[2])
	{
		return true;
	} 
	else
